...
<header>
    ...
    <div class="song_side">
        <nav>
            ...
            <div class="user">
                <img src="img/KDS CODER.png" alt="User" title="">
            </div>
        </nav>
        <div class="content">
        ...
        <div class="popular_artists">
            ...
            <div class="item">
                <li>
                    <img src="images\gabrian.jpeg" alt="Arjit Singh" title="Arjit Singh">
                </li>
                <li>
                    <img src="img/bellie.jpg" alt="Alan Walker" title="Alan Walker">
                </li>
                <li>
